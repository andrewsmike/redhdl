...
from redhdl.voxel.schematic import load_schem, save_schem
...
def assemble_module(module_name: str):
    ...
    instance_configs, port_slice_assignments = netlist_template_from_vhdl_path(
        vhdl_path, module_name
    )
...
def arg_parser() -> ArgumentParser:
    ...
    parser.add_argument("module_name", help="the root SV module to compile")
    parser.add_argument(
        "--list-modules",
