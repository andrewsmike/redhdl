"""
This file is directly copied from https://github.com/iterative/dvc/blob/0.94.0/dvc/dagascii.py
with only minor alterations.
Please see the apache license at https://github.com/iterative/dvc/blob/main/LICENSE for more info.
"""
"""Draws DAG in ASCII."""
...
def find_pager():
    ...
    logger.warning(
        ...
        "{} for more info.".format("https://man.dvc.org/pipeline/show")
    )
    return pydoc.plainpager
